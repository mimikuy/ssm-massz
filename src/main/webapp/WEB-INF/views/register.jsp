...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="mui-input-row">
            <input type="text" name="user_name" id="user_name" class="mui-input-clear" maxlength="30" placeholder="请输入手机号/用户名/邮箱">

        </div>
        <div class="mui-input-row mui-password">
            <input type="password" name="password" id="password" class="mui-input-password" maxlength="20" placeholder="请输入登录密码">
        </div>
        <div class="login-box">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        // 判断登录按钮是否可点击
        function checkBtn(){
            if($("#username").val()!="" && $("#password").val()!="" && checkBoxValue){
